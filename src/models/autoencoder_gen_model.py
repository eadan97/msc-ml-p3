...
class AutoencoderGenModel(LightningModule):
    ...
    def __init__(
        ...
        ResnetGenerator(3, 3, 64, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9)
        self.encoder = valid_encoders[enc_type]['enc'](first_conv, maxpool1)
        self.decoder = valid_encoders[enc_type]['dec'](self.ngf, self.input_height, first_conv, maxpool1)

        self.fc = nn.Linear(self.enc_out_dim, self.ngf)
        # loss function
