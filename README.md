...
## Description
This repository contains the code used for the experimentation of the third project for the Machine Learning course of the ITCR MSc in Computer Science.
...
│   ├── losses                  <- Lightning losses
│   ├── models                  <- Lightning models
│   ├── transforms              <- Transoforms for data (noise)
