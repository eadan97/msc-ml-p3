...
## PlantVillage Classification Using AutoEncoders 
...
## Description
This repository contains the code used for the experimentation bla bla bla

## How to run
Install dependencies
```yaml
# clone project
git clone https://github.com/eadan97/msc-ml-p3
cd your-repo-name
